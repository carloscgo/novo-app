...
Make sure you've followed the instructions for [Setup and development](README.md#setup-and-development). If you already have, try deleting the `node_modules` folder and installing fresh:
